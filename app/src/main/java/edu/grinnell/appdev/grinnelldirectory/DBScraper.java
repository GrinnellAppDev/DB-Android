...
public class DBScraper extends AsyncTask<String, Void, List<Person>> {
	...
	List<Person> persons; // The final product, a list of downloaded
									// Profile objects
	...
	public DBScraper(Context context) {
		super();
		mActivity = context;
	...
	private int makeRequest() {
		...
		try {
			...
			if (response.isSuccessful()) {
                ...
                // TODO: 4/12/17 HANDLE UNSUCCESSFUL
            }
		} catch (IOException e) {
            // TODO: 4/12/17 handle error
        }
		return -1;
	}
	...
	private boolean parseResponse() {
		...
		curTok = strTok.nextToken();
			...
			do {
				...
				// parsed information
                Person person;
				persons.add(new Profile(picurl, firstName, lastName,
